...
// ANSWER: No, this loop will keep running O(n) will need to done with this loop. 
...
// ANSWER: Yes they do have the same space complexity. 
...
// ANSWER: By way the code is written, Otherhand, it was also the output of the code in itself. 
